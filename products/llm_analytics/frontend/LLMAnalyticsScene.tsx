...
function LLMAnalyticsDashboard(): JSX.Element {
    ...
    const dashboardLogicInstance = React.useMemo(
        () =>
            selectedDashboardId
                ? dashboardLogic({ id: selectedDashboardId, placement: DashboardPlacement.Embedded })
                : null,
        [selectedDashboardId]
    )

    const fallbackLogicInstance = React.useMemo(
        () => dashboardLogic({ id: 0, placement: DashboardPlacement.Embedded }),
        []
    )
            ...
            <div className="@container/dashboard">
                ...
                {useCustomizableDashboard ? (
                    availableDashboardsLoading || !selectedDashboardId ? (
                        ...
                        <Dashboard id={selectedDashboardId.toString()} placement={DashboardPlacement.Embedded} />
                    )
                ) : (
                    <Tiles />
                )}
